      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-10 mb-10">
        ...
        <div>
          <div className="flex items-center gap-3 mb-4">
            <div className="bg-yellow-400 text-blue-900 font-black text-xl px-3 py-1 rounded">
              GNR²
            </div>
            <div>
          ...
          <div className="flex gap-4 mt-5">
            <a href="#" className="bg-blue-600 hover:bg-blue-500 w-9 h-9 rounded-full flex items-center justify-center transition">
              <i className="fa-brands fa-facebook-f text-sm"></i>
            </a>
            <a href="#" className="bg-pink-600 hover:bg-pink-500 w-9 h-9 rounded-full flex items-center justify-center transition">
            ...
            <a href="#" className="bg-blue-400 hover:bg-blue-300 w-9 h-9 rounded-full flex items-center justify-center transition">
