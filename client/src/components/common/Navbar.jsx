...
export default function Navbar() {
  ...
  return (
    <nav className="bg-[#FACC15] text-gray-900 px-6 py-4 flex justify-between items-center shadow-lg relative z-50">

      <Link to="/" className="flex items-center">
        <img src={logo} alt="GNR Square Logo" className="h-12 w-auto object-contain" />
      </Link>

      <div className="hidden md:flex gap-6 text-sm font-medium items-center">
        <Link to="/" className="hover:text-yellow-600 transition"><i className="fa-solid fa-house mr-1"></i>Home</Link>
        <Link to="/services" className="hover:text-yellow-600 transition"><i className="fa-solid fa-grid-2 mr-1"></i>Services</Link>
        <Link to="/about" className="hover:text-yellow-600 transition"><i className="fa-solid fa-circle-info mr-1"></i>About</Link>
        <Link to="/contact" className="hover:text-yellow-600 transition"><i className="fa-solid fa-phone mr-1"></i>Contact</Link>
        ...
        {user ? (
          ...
          <div className="flex items-center gap-3">
            <Link to="/login" className="hover:text-yellow-600 transition text-sm font-medium">Login</Link>
            <Link to="/register" className="bg-blue-900 text-yellow-400 px-4 py-2 rounded-full font-bold hover:bg-blue-800 transition text-sm">Register</Link>
          </div>
        )}
      </div>
      ...
      {open && (
        <div className="absolute top-16 left-0 w-full bg-blue-900 text-white flex flex-col items-center gap-4 py-6 md:hidden border-t border-blue-800">
          ...
          <Link to="/about" onClick={() => setOpen(false)} className="hover:text-yellow-400 transition">About</Link>
          ...
          {user ? (
            ...
            <>
              <Link to="/login" onClick={() => setOpen(false)} className="hover:text-yellow-400 transition">Login</Link>
